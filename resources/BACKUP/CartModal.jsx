...
import { addToCart, removeFromCart, updateQuantity, setPaymentMethod, clearCart } from '../../Redux/cartSlice';
...
const CartModal = () => {
  ...
  console.log('🛒 Cart Items with addressId:', cartItems);
    ...
    if (method === 'offline') {
      try {
        ...
        router.visit('/order-confirmation', {
          method: 'GET',
          data: { orderId: response.data.order.id },
        });
      } catch (error) {
      ...
      // TODO: Implement online payment logic later
      console.log('Online payment to be implemented later');
    }
  };
          ...
          {selectedAddress && (
            <div className="mb-4 text-sm text-gray-600">
              ...
              <p>
                ...
                {selectedAddress.pinCode || selectedAddress.pin_code || 'N/A'}
              </p>
