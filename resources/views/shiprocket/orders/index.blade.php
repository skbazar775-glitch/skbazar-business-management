...
<form id="pickup-form" class="space-y-6">
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
        <h3 class="text-lg font-semibold text-gray-800 mb-5">Schedule Pickup Request</h3>
        
        <div class="space-y-5">
            <!-- Shipment ID Field -->
            <div>
                <label for="pickup-shipment-id" class="block text-sm font-medium text-gray-700 mb-1">Shipment ID</label>
                <div class="relative">
                    <input type="text" id="pickup-shipment-id" name="shipment_id" 
                           value="${awbData.shipment_id || shipmentId}" readonly
                           class="block w-full pl-3 pr-10 py-2.5 rounded-md bg-gray-50 border border-gray-200 text-gray-600 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 sm:text-sm cursor-not-allowed">
            ...
            <!-- Status Field -->
            <div>
                <label for="pickup-status" class="block text-sm font-medium text-gray-700 mb-1">Status</label>
                <select id="pickup-status" name="status" 
                        class="block w-full pl-3 pr-10 py-2.5 text-base rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 sm:text-sm">
                    <option value="">Select status...</option>
                    <option value="retry" class="text-amber-600">Retry</option>
                    <option value="urgent" class="text-red-600">Urgent</option>
                    <option value="standard" class="text-blue-600">Standard</option>
                </select>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input type="date" id="pickup-date" name="pickup_date" 
                           ...
                           class="block w-full pl-3 pr-10 py-2.5 rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 sm:text-sm">
                    <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                        <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex justify-end">
        <button type="submit" class="inline-flex items-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-150">
                                ...
                                document.getElementById('pickup-form').addEventListener('submit', function(e) {
                                    ...
                                    .then(pickupResponse => {
                                        if (pickupResponse.error) {
                                            ...
                                            let pickupHtml = '<h4 class="font-medium text-gray-900">Successfully Scheduled </h4>';
                                            pickupHtml += `
...
<form id="pickup-form" class="space-y-6">
    <div class="bg-white shadow rounded-lg p-6">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Schedule Pickup</h3>
        ...
        <div class="grid grid-cols-1 gap-y-5 gap-x-4 sm:grid-cols-6">
            ...
            <div class="sm:col-span-6">
                ...
                <div class="relative rounded-md shadow-sm">
                    <input type="text" id="pickup-shipment-id" name="shipment_id" value="${shipmentId}" readonly 
                           class="block w-full rounded-md border-gray-300 pl-3 pr-10 py-2 bg-gray-50 text-gray-600 focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            ...
            <div class="sm:col-span-3">
                <label for="pickup-date" class="block text-sm font-medium text-gray-700 mb-1">Pickup Date</label>
                <div class="relative rounded-md shadow-sm">
                    <input type="date" id="pickup-date" name="pickup_date" min="${new Date().toISOString().split('T')[0]}" 
                           class="block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm">
                    <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                        <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
