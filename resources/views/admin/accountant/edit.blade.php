...
<div class="container-fluid px-4 py-6">
    ...
    <div class="card bg-white shadow-lg rounded-xl overflow-hidden" data-aos="fade-up">
        <div class="card-header bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 px-6">
            <h4 class="text-xl font-bold mb-0">Edit Accountant</h4>
        </div>
        <div class="card-body p-6">
            ...
            <form action="{{ route('admin.accountants.update', $accountant) }}" method="POST">
                ...
                <div class="mb-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <input type="text" name="name" id="name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('name') border-red-500 @enderror" value="{{ old('name', $accountant->name) }}">
                    @error('name')
                ...
                <div class="mb-4" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <input type="email" name="email" id="email" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('email') border-red-500 @enderror" value="{{ old('email', $accountant->email) }}">
                    @error('email')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
