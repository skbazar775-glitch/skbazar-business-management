...
<div class="container-fluid px-4 py-6">
    ...
    <div class="card bg-white shadow-lg rounded-xl overflow-hidden" data-aos="fade-up">
        <div class="card-header bg-gradient-to-r from-green-600 to-emerald-700 text-white py-4 px-6">
            <h4 class="text-xl font-bold mb-0">Create Technician</h4>
        </div>
        <div class="card-body p-6">
            <!-- Back Button -->
            <a href="{{ route('admin.technicians.index') }}" 
               class="btn bg-gradient-to-r from-gray-600 to-gray-800 text-white px-4 py-2 rounded-lg hover:shadow-lg hover:scale-105 transition-all mb-6 inline-block" 
               data-aos="fade-right">
            ...
            <form action="{{ route('admin.technicians.store') }}" method="POST">
                ...
                <div class="flex justify-end" data-aos="fade-up" data-aos-delay="500">
                    <button type="submit" 
                        class="btn bg-gradient-to-r from-green-500 to-emerald-600 text-white px-4 py-2 rounded-lg hover:shadow-lg hover:scale-105 transition-all">
