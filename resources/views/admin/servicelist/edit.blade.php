                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select name="status" id="status" class="form-select @error('status') is-invalid @enderror">
                            <option value="0" {{ $service->status == 0 ? 'selected' : '' }}>Active</option>
                            <option value="1" {{ $service->status == 1 ? 'selected' : '' }}>Inactive</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
