<!-- resources/views/admin/about-us/create.blade.php -->
@extends('layouts.admin')

@section('title', 'Create About Us')

@section('content')
    <h1 class="text-2xl font-bold mb-6">Create About Us Content</h1>
    ...
    <form action="{{ route('admin.about-us.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="point_1" id="point_1" class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700" value="{{ old('point_1') }}">
        </div>
        <div class="mb-4">
            <label for="point_2" class="block text-gray-300">Point 2</label>
            <input type="text" name="point_2" id="point_2" class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700" value="{{ old('point_2') }}">
        </div>
        <div class="mb-4">
            <label for="point_3" class="block text-gray-300">Point 3</label>
            <input type="text" name="point_3" id="point_3" class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700" value="{{ old('point_3') }}">
        </div>
        <div class="mb-4">
            <label for="button_text" class="block text-gray-300">Button Text</label>
            <input type="text" name="button_text" id="button_text" class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700" value="{{ old('button_text') }}">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="ceo_name" id="ceo_name" class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700" value="{{ old('ceo_name') }}">
        </div>
        <div class="mb-4">
            <label for="ceo_title" class="block text-gray-300">CEO Title</label>
            <input type="text" name="ceo_title" id="ceo_title" class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700" value="{{ old('ceo_title') }}">
        </div>
        <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 hover-glow">Create About Us</button>
