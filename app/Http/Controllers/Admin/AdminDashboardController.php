...
class AdminDashboardController extends Controller
{
    public function dashboard()
    {
        ...
        // Helper function to calculate sales, profit, and expenses for a given date range
        $calculateFinancials = function ($start, $end, $status = 4) {
            ...
            // Profit: Calculate based on order items
        ...
        // Total Sales, Profit, and Expenses (current month vs last month)
        ...
        $currentMonthExpenses = $currentMonthFinancials['expenses'];
        $lastMonthExpenses = $lastMonthFinancials['expenses'];
        $expensesPercentageChange = $lastMonthExpenses > 0
            ? round((($lastMonthExpenses - $currentMonthExpenses) / $lastMonthExpenses) * 100, 1)
        ...
        // Sales, Profit, and Expenses Analytics Data
        ...
        for ($i = 11; $i >= 0; $i--) {
            ...
            $monthlyExpensesData[] = $financials['expenses'];
        }

        // Quarterly (last 8 quarters)
        $quarterlySalesData = [];
        $quarterlyProfitData = [];
        $quarterlyExpensesData = [];
        $quarterlyLabels = [];
        for ($i = 7; $i >= 0; $i--) {
            ...
            $quarterlyExpensesData[] = $financials['expenses'];
        }
        ...
        for ($i = 4; $i >= 0; $i--) {
            ...
            $yearlyExpensesData[] = $financials['expenses'];
        }
        ...
        for ($i = 29; $i >= 0; $i--) {
            ...
            $dailyExpensesData[] = $financials['expenses'];
        }
